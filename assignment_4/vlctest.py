...
model.load_state_dict(torch.load("hand_gesture_v1", map_location = torch.device('cpu')))
model.eval()

sfolder = sys.argv[1]
playlist = os.listdir(sfolder)
