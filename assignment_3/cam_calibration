...
img_all = glob.glob('../input/camdata/*.jpg')
...
np.savez('../input/calib.npz', mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)
...
img = cv2.imread('../input/camdata/11.jpg')
h, w = img.shape[:2]
...
# plt.imshow(undistortedImg,'gray'),plt.show()
